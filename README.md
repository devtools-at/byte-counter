...
<p align="center">
  <a href="https://devtools.at/tools/byte-counter"><img src="https://img.shields.io/badge/Try%20Online-DevTools.at-blue?style=for-the-badge" alt="Try Online"></a>
...
<p align="center">
  <b>Count bytes in text</b>
</p>

<p align="center">
  <a href="https://devtools.at/tools/byte-counter">Try Online</a> •
...
**[Try Byte Counter online at DevTools.at →](https://devtools.at/tools/byte-counter)**
...
## What is Byte Counter?

Count bytes in text. This is a standalone TypeScript/JavaScript implementation that you can use in your own projects.
...
```typescript
import { process } from '@devtools-at/byte-counter';
